...
public class YonghuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YonghuEntity user = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("yonghuhao", username));
    ...
    public R register(@RequestBody YonghuEntity yonghu){
    	...
    	YonghuEntity user = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("yonghuhao", yonghu.getYonghuhao()));
		if(user!=null) {
