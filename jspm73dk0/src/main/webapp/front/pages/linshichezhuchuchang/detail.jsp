				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>出场时间：</span>
							<span class="desc">
								{{detail.chuchangshijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>停车时长：</span>
							<span class="desc">
								{{detail.tingcheshizhang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>停车价格：</span>
		...
		<script>
			var vue = new Vue({
				...
				data: {
					...
					buynumber: 1,
					// 当前详情页表
					detailTable: 'linshichezhuchuchang',
					// 评价列表
					dataList: [],
					// 选座座位列表
					numberList: []
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`linshichezhuchuchang`);
