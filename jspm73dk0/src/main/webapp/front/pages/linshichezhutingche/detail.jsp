				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('linshichezhutingche','停车出场')" @click="onAcrossTap('linshichezhuchuchang')" type="button" class="layui-btn">
								停车出场
							</button>
		...
		<script>
			var vue = new Vue({
				...
				data: {
					...
					buynumber: 1,
					// 当前详情页表
					detailTable: 'linshichezhutingche',
					// 评价列表
					dataList: [],
					// 选座座位列表
					numberList: []
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`linshichezhutingche`);
