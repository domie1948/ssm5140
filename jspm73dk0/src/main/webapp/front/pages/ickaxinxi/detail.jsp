				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('ickaxinxi','临时车主入场')" @click="onAcrossTap('linshichezhutingche')" type="button" class="layui-btn">
								临时车主入场
							</button>
																					<button v-if="isAuth('ickaxinxi','固定车主入场')" @click="onAcrossTap('gudingchezhutingche')" type="button" class="layui-btn">
								固定车主入场
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`ickaxinxi`);
