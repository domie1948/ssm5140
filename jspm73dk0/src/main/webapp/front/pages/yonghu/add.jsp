		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="chezhuleixing" id="chezhuleixing" lay-filter="chezhuleixing">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in chezhuleixing" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																vue.xingbie = '男,女'.split(',')
																								vue.chezhuleixing = '固定车主,临时车主'.split(',')
