...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>车主类型</label>
										<select id="chezhuleixingSelect" name="chezhuleixing" class="form-control">
												<option value=""></option>
												<option class="chezhuleixingOption" value="固定车主">
													固定车主
												</option>
												<option class="chezhuleixingOption" value="临时车主">
													临时车主
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function dataBind(){
			...
			var chezhuleixingOptions = document.getElementsByClassName("chezhuleixingOption");
			for(var chezhuleixingCount = 0; chezhuleixingCount < chezhuleixingOptions.length;chezhuleixingCount++){
				if(chezhuleixingOptions[chezhuleixingCount].getAttribute('value') == ruleForm.chezhuleixing){
					chezhuleixingOptions[chezhuleixingCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					var chezhuleixingOptions = document.getElementsByClassName("chezhuleixingOption");
						for(var chezhuleixingCount = 0; chezhuleixingCount < chezhuleixingOptions.length;chezhuleixingCount++){
							if(chezhuleixingOptions[chezhuleixingCount].getAttribute('value') == res.data.chezhuleixing){
								chezhuleixingOptions[chezhuleixingCount].setAttribute('selected','selected');
							}
						}
					}
